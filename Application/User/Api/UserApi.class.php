...
class UserApi extends Api{
     ...
     * @param Boolean $verifyUser 是否验证码密码
     * @return true 修改成功，false 修改失败
     * @author huajie <banhuajie@163.com>
     */
    public function updateInfo($uid, $password, $data,$verifyUser = true){
        if($this->model->updateUserFields($uid, $password, $data,$verifyUser) !== false){
            $return['status'] = true;
        }else{
            $return['status'] = false;
